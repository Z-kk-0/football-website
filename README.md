...
| 9  | ProtectedRoute Component leitet nicht-authentifizierte User weiter | Rendern von `<ProtectedRoute>` ohne `user` im AuthContext                                           | Rendert `<Navigate to="/nologin" replace />`                                          | Unit (Frontend) |
